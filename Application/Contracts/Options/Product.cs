...
namespace Application.Contracts.Options {
    public class Product : INonPathDependentContract {
        ...
        public IEnumerable<Tuple<DateTime, INonPathDependentPayoff>> Payoffs => [Tuple.Create(Maturity, (INonPathDependentPayoff)new ProductNonPathDependentPayoff(Contracts.Select(c => c.Payoff).ToList()))];
