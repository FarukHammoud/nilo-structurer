namespace Domain {
    public interface IIndicator {
        ...
        /// </summary>
        /// <param name="contract">The contract for which the indicator is being calculated.</param>
        ...
        IList<(IMarketData, DateTime)> GetShiftedMarketData(
