...
namespace PricerServices {
    public class AmericanCallPricer : IPricer<AmericanCallOption> {
        private readonly MarketDataService _marketDataService;
        private readonly Random _random;
        public AmericanCallPricer(MarketDataService marketDataService) {
            _marketDataService = marketDataService;
            _random = new Random();
        }

        public double Price(AmericanCallOption contract) {
